...
-- since setting wal_keep_size_mb to 0 is not safe for master/standby,
-- we are not going to set wal_keep_size_mb to 0 now, to avoid flaky tests
\! gpconfig -c wal_keep_size_mb -v 64
\! gpstop -u
-- end_ignore
-- stop a mirror
