...
PG_KEYWORD("active", ACTIVE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("concurrency", CONCURRENCY, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("contains", CONTAINS, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("cpu_rate_limit", CPU_RATE_LIMIT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("cpuset", CPUSET, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("create", CREATE, RESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("createexttable", CREATEEXTTABLE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("endpoint", ENDPOINT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("enum", ENUM_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("errors", ERRORS, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("exchange", EXCHANGE, UNRESERVED_KEYWORD, AS_LABEL)    /* GPDB */
...
PG_KEYWORD("fields", FIELDS, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("fill", FILL, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("hash", HASH, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("host", HOST, UNRESERVED_KEYWORD, AS_LABEL)              /* GPDB */
...
PG_KEYWORD("inclusive", INCLUSIVE, UNRESERVED_KEYWORD, AS_LABEL)    /* GPDB */
...
PG_KEYWORD("list", LIST, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("log", LOG_P, TYPE_FUNC_NAME_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("logged", LOGGED, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("mapping", MAPPING, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("master", MASTER, UNRESERVED_KEYWORD, AS_LABEL)      /* GPDB */
...
PG_KEYWORD("median", MEDIAN, COL_NAME_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("memory_limit", MEMORY_LIMIT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("memory_shared_quota", MEMORY_SHARED_QUOTA, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("memory_spill_ratio", MEMORY_SPILL_RATIO, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("method", METHOD, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("minute", MINUTE_P, UNRESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("minvalue", MINVALUE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("missing", MISSING, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("mode", MODE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("modifies", MODIFIES, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("newline", NEWLINE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("nocreateexttable", NOCREATEEXTTABLE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("none", NONE, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("noovercommit", NOOVERCOMMIT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("overcommit", OVERCOMMIT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("partition", PARTITION, RESERVED_KEYWORD, BARE_LABEL)         /* GPDB */
PG_KEYWORD("partitions", PARTITIONS, UNRESERVED_KEYWORD, BARE_LABEL)     /* GPDB */
PG_KEYWORD("passing", PASSING, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("password", PASSWORD, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("percent", PERCENT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("persistently", PERSISTENTLY, UNRESERVED_KEYWORD, AS_LABEL) /* GPDB */
...
PG_KEYWORD("protocol", PROTOCOL, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("publication", PUBLICATION, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("queue", QUEUE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("quote", QUOTE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("randomly", RANDOMLY, UNRESERVED_KEYWORD, AS_LABEL)        /* GPDB */
PG_KEYWORD("range", RANGE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("read", READ, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("readable", READABLE, UNRESERVED_KEYWORD, AS_LABEL)        /* GPDB */
PG_KEYWORD("reads", READS, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("reject", REJECT_P, UNRESERVED_KEYWORD, AS_LABEL)          /* GPDB */
...
PG_KEYWORD("resource", RESOURCE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("restart", RESTART, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("restrict", RESTRICT, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("retrieve", RETRIEVE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("segment", SEGMENT, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
PG_KEYWORD("segments", SEGMENTS, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("split", SPLIT, UNRESERVED_KEYWORD, AS_LABEL)             /* GPDB */
...
PG_KEYWORD("subpartition", SUBPARTITION, UNRESERVED_KEYWORD, AS_LABEL)    /* GPDB */
...
PG_KEYWORD("threshold", THRESHOLD, UNRESERVED_KEYWORD, AS_LABEL)          /* GPDB */
...
PG_KEYWORD("validation", VALIDATION, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("web", WEB, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("writable", WRITABLE, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
