...
PG_CMDTAG(CMDTAG_DECLARE_RETRIEVE, "RETRIEVE", false, false, true)
...
PG_CMDTAG(CMDTAG_MPPEXEC, "MPPEXEC", false, false, true)
PG_CMDTAG(CMDTAG_MPPDTX, "MPPDTX", false, false, true)
