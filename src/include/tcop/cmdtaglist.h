...
/* GPDB-specific */
PG_CMDTAG(CMDTAG_ALTER_PROTOCOL, "ALTER PROTOCOL", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_QUEUE, "CREATE QUEUE", true, false, false)
PG_CMDTAG(CMDTAG_CREATE_RESOURCE_GROUP, "CREATE RESOURCE GROUP", true, false, false)
PG_CMDTAG(CMDTAG_DROP_PROTOCOL, "DROP PROTOCOL", true, false, false)
PG_CMDTAG(CMDTAG_DROP_QUEUE, "DROP QUEUE", true, false, false)
PG_CMDTAG(CMDTAG_DROP_RESOURCE_GROUP, "DROP RESOURCE GROUP", true, false, false)
