...
PG_CMDTAG(CMDTAG_CREATE_EXTERNAL_TABLE, "CREATE EXTERNAL TABLE", false, false, false)
PG_CMDTAG(CMDTAG_CREATE_PROTOCOL, "CREATE PROTOCOL", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_PROTOCOL, "DROP PROTOCOL", false, false, false)
