...
bloom_set_t *bloom_set_init(const uint32_t bloom_count, const uint32_t bloom_size, void *mem);
...
bloom_t    *bloom_set_move(bloom_set_t * bloom_set, Oid dbid, void *mem);
