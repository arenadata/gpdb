	...
	PARTITION BY RANGE (a)
		SUBPARTITION BY RANGE (b)
			SUBPARTITION TEMPLATE (
				...
				SUBPARTITION BY RANGE (d) SUBPARTITION TEMPLATE (START (1) END (3) EVERY (1))
...
INSERT INTO part_table SELECT i,1,1,1,1,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,1,2,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,2,1,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,2,2,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,1,1,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,1,2,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,2,1,'sub_prt1' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,2,2,'sub_prt1' FROM generate_series(1,100) as i;
...
INSERT INTO part_table SELECT i,2,2,2,2,'sub_prt1' FROM generate_series(1,100) as i;

INSERT INTO part_table SELECT i,1,1,1,1,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,1,2,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,2,1,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,1,2,2,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,1,1,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,1,2,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,2,1,'sub_prt2' FROM generate_series(1,100) as i;
INSERT INTO part_table SELECT i,1,2,2,2,'sub_prt2' FROM generate_series(1,100) as i;
...
INSERT INTO part_table SELECT i,2,2,2,2,'sub_prt2' FROM generate_series(1,100) as i;
